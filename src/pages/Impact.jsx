...
const Impact = () => {
  ...
  return (
    <div className="relative pt-16 md:pt-20">
      ...
      >
        ...
        <div className="relative z-20 text-center max-w-5xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-medium text-stone mb-6 sm:mb-8 md:mb-10 lg:mb-12 leading-[0.9] tracking-tight font-chillax">
            Making
            <span className="block text-stone">Impact</span>
          </h1>
        ...
        <div className="w-full h-full flex items-center">
          <div className="grid lg:grid-cols-2 w-full h-full items-center min-h-0">
            ...
            <div className="text-center lg:text-left space-y-6 sm:space-y-8 lg:space-y-10 order-1 lg:order-2 px-6 sm:px-8 md:px-8 lg:px-12 xl:px-16 flex flex-col justify-center h-full py-12 md:py-0">
              ...
              <div className="space-y-4 sm:space-y-6">
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-stone/70 max-w-xl font-light leading-relaxed">
                ...
                <p className="text-sm sm:text-base md:text-lg text-stone/60 max-w-lg font-light leading-relaxed">
        ...
        <div className="w-full max-w-7xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16">
          <div className="text-center space-y-12 sm:space-y-16 lg:space-y-20">
            ...
            <div className="grid md:grid-cols-3 gap-8 sm:gap-12 lg:gap-16">
              <div className="space-y-4 sm:space-y-6">
                <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto bg-stone rounded-full flex items-center justify-center">
                  <span className="text-white text-2xl sm:text-3xl font-bold">
                    1
                  </span>
                </div>
                <h3 className="text-lg sm:text-xl md:text-2xl font-medium text-stone">
                  You Shop
                </h3>
                <p className="text-sm sm:text-base text-stone/60 max-w-xs mx-auto leading-relaxed">
      ...
      <section
        data-section="cta"
        className="h-screen w-full rounded-t-[3rem] overflow-hidden bg-stone flex items-center"
      >
        <div className="w-full max-w-5xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 text-center">
          <div className="space-y-8 sm:space-y-12 lg:space-y-16">
            <div className="space-y-6 sm:space-y-8">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-medium tracking-tight text-white leading-[0.9] font-chillax">
                Feel Good.
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 lg:gap-8 justify-center">
              <Link to="/shop">
                <ImpactButton
                  variant="outline"
                  className="px-8 py-4 sm:px-10 sm:py-5 text-base sm:text-lg md:text-xl font-medium tracking-wide text-white border-white hover:bg-white hover:text-stone"
                >
                  Shop Collection
                </ImpactButton>
              </Link>
