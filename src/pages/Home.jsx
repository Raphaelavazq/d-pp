...
export default function Home() {
  ...
  return (
    <div className="relative pt-16 md:pt-20">
      {/* Hero Section - Ready to Experience düpp? */}
      <section
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-4xl px-4 sm:px-6 md:px-8 lg:px-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-medium text-stone mb-4 sm:mb-6 md:mb-8 lg:mb-12 leading-[0.9]">
            Ready to
            <span className="block text-stone">Experience düpp?</span>
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-stone/80 mb-6 sm:mb-8 md:mb-10 lg:mb-16 max-w-2xl mx-auto leading-relaxed font-light">
          ...
          <div className="grid lg:grid-cols-2 w-full h-full items-center">
            ...
            <div className="text-center lg:text-left space-y-4 sm:space-y-6 lg:space-y-8 order-1 lg:order-2 px-6 sm:px-8 md:px-8 lg:px-12 flex flex-col justify-center h-full py-8 md:py-0">
              <div className="space-y-2 sm:space-y-4">
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-medium tracking-tight text-stone leading-[1.1] px-2 sm:px-0">
                  Confident and
              ...
              <div className="space-y-2 sm:space-y-4 hidden md:block">
                <p className="text-sm sm:text-base md:text-lg lg:text-xl text-stone sm:text-stone/70 max-w-xl font-light leading-relaxed">
                  Welcome to düpp
                </p>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 w-full h-full items-center">
            ...
            <div className="text-center lg:text-left space-y-4 sm:space-y-6 lg:space-y-8 px-6 sm:px-8 md:px-8 lg:px-12 flex flex-col justify-center h-full py-8 md:py-0">
              <div ref={heroTextRef} className="space-y-2 sm:space-y-4">
                <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-medium tracking-tight text-stone leading-[1.1] px-2 sm:px-0">
                  Soft, Simple
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 w-full text-center">
          ...
          <p className="text-sm sm:text-base md:text-lg mb-8 sm:mb-10 md:mb-12 leading-relaxed max-w-2xl mx-auto text-stone font-medium">
          ...
          <form className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-lg mx-auto mb-6 sm:mb-8">
            <input
              ...
              required
              className="flex-1 px-4 sm:px-6 py-3 sm:py-4 rounded-none border-b-2 border-stone bg-transparent placeholder-stone focus:outline-none focus:border-coal text-base sm:text-lg transition-all duration-200 text-coal"
            />
            <button
              type="submit"
          ...
          <footer className="text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12 lg:gap-16 mb-8 sm:mb-10 md:mb-12">
              ...
              <div className="md:col-span-2 lg:col-span-2 space-y-4 sm:space-y-6">
                <h3 className="text-2xl sm:text-3xl font-medium text-stone">
                  düpp
                </h3>
                <p className="text-sm sm:text-base md:text-lg text-stone/70 max-w-md mx-auto lg:mx-0 leading-relaxed">
              ...
              <div className="space-y-3 sm:space-y-4 hidden sm:block">
                <h4 className="text-lg sm:text-xl font-medium text-stone">
                  Quick Links
                </h4>
                <ul className="space-y-2 sm:space-y-3">
                  <li>
                    <a
                      href="/shop"
                      className="text-sm sm:text-base text-stone/70 hover:text-stone transition-colors"
                    >
                      Shop
                    </a>
                  </li>
            ...
            {/* Bottom Footer */}
            <div className="border-t border-stone/20 pt-6 sm:pt-8 flex flex-col lg:flex-row justify-between items-center space-y-3 sm:space-y-4 lg:space-y-0">
              <p className="text-stone/60 text-xs sm:text-sm">
                © 2024 düpp. All rights reserved.
              </p>
              <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
                <a
                  href="/privacy"
                  className="text-stone/60 hover:text-stone text-xs sm:text-sm transition-colors"
                >
                  Privacy Policy
                </a>
                <a
