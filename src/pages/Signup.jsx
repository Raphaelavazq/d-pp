...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rhode-cream to-white">
      {/* Top Section with Navbar Layout */}
      <section className="pt-24 pb-8">
        <div className="max-w-6xl mx-auto px-8">
          <div className="bg-white/40 backdrop-blur-sm rounded-3xl shadow-sm border border-white/20">
            <div className="grid grid-cols-3 items-center h-20 px-8">
              {/* Left Side */}
              <div className="flex items-center">
                <span
                  className="text-lg font-normal text-rhode-text leading-relaxed uppercase"
              ...
              <div className="flex items-center justify-center">
                <h2
                  className="text-xl font-medium text-rhode-text"
                  style={{ fontFamily: "Aglonema, serif" }}
                >
                  Join düpp
                </h2>
              ...
              <div className="flex items-center justify-end">
                <Link
                  to="/login"
                  className="text-sm text-rhode-text hover:text-rhode-dark transition-colors font-medium"
                >
